...
import machiev.stream.RandomAccessDataInputStream;
...
/**
 * This class is a copy of {@link org.apache.commons.compress.archivers.zip.ZipFile}
 * but backed up by a custom stream instead of {@link RandomAccessFile}.
 *
 * This class was created to overcome limitations of {@link org.apache.commons.compress.archivers.zip.ZipArchiveInputStream}
...
public class InMemoryZip implements Closeable {
     ...
     */
    private final RandomAccessDataInputStream archive;
    ...
    public InMemoryZip(final ByteArrayInputStream in, final String encoding, final boolean useUnicodeExtraFields)
        ...
        archive = new RandomAccessDataInputStream(in);
    ...
    /**
     * Transfer selected entries from this zip archive to a given #ZipArchiveOutputStream.
     ...
     * same encoding that as been specified for this ZipStream.</p>
     *
    ...
    /**
     * Ensures that the close method of this zip stream is called when
    ...
    protected void finalize() throws Throwable {
        try {
            if (!closed) {
                System.err.println("Cleaning up unclosed archive stream");
                close();
            }
        } finally {
            super.finalize();
