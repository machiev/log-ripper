...
import org.apache.commons.compress.input.RandomAccessDataInput;
...
public class ZipArchive implements Closeable {
     ...
     */
    private final RandomAccessDataInput archive;
     ...
     */
    public ZipArchive(final RandomAccessDataInput dataInput, final String encoding, final boolean useUnicodeExtraFields)
            throws IOException {
    ...
    protected void finalize() throws Throwable {
        try {
            if (!closed) {
                System.err.println("Cleaning up unclosed ZipArchive");
                close();
            }
        } finally {
            super.finalize();
